jQuery(document).ready(function ($) {
    ...
    /* Convert all english numbers to persian numbers  */
    if (Window.Lang === "fa") {
    ...
    if ($map.length) {
        $map.gMap({
            scrollwheel: false,
            address: 'No: 2, kalantar, Tabriz, East Azerbyjan, IRAN',
            zoom: 18,
            markers: [{
                'address': 'No: kalantar kuche 2, kalantar, Tabriz, East Azerbyjan, IRAN',
                'content': 'My School',
                'popup': true
            }]
        });
