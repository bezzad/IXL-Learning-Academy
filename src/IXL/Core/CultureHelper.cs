...
namespace IXL.Core
{
    public static class CultureHelper
    {
        ...
        public static readonly Dictionary<string, LanguageModels> Languages;

        static CultureHelper()
        {
            var langs = Connections.IxlDb.SqlConn.Query<LanguageModels>("Select * From udfv_LanguagesView()").ToList();
